...
INSERT INTO `script_data` (`script_data_id`, `script_data_numero_client`, `script_data_c_app_nom`, `script_data_c_app_prenom`, `script_data_c_app_adresse`, `script_data_c_app_cp`, `script_data_c_app_ville`, `script_data_nbr_volet`, `script_data_n_serie`, `script_data_is_mini_site`, `script_data_is_pq`, `script_data_info_comp`, `script_data_reparateur_qualifie_fk`) VALUES
(30, 0, '', NULL, '', 0, '', 0, '', 1, 1, '', NULL),
(31, 10017, 'azer', NULL, 'ZERZ', 0, 'RZERZE', 0, '', 1, 1, '', 169),
(32, 10206, '', NULL, '', 0, '', 0, '', 1, 1, '', 488),
(33, 10206, '', NULL, '', 0, '', 0, '', 1, 1, '', 488),
(34, 10206, '', NULL, '', 0, '', 0, '', 1, 1, '', 488),
(35, 10206, '', NULL, '', 0, '', 0, '', 1, 1, '', 488),
(36, 10206, '', NULL, '', 0, '', 0, '', 1, 1, '', 488),
(37, 10186, '', '', '', 0, '', 0, '', 1, 1, '', 172);
...
--
ALTER TABLE `script_data`
  MODIFY `script_data_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `script_data_child`
--
ALTER TABLE `script_data_child`
  MODIFY `script_data_child_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
