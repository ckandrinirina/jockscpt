...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2020 at 01:00 PM
...
(232, 2, 5, 5, 'Réparateur qualifié', 'Appel sur', 54),
(233, 5, 20, 10, 'SAV – Volet Bubendorff sous garantie (moins de 7 ans)', 'Demande', 54),
(234, 1, 2, 0, 'Mini-site', 'Choix', 54);
...
--
ALTER TABLE `script_data`
  MODIFY `script_data_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `script_data_child`
--
ALTER TABLE `script_data_child`
  MODIFY `script_data_child_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;
