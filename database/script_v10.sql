...
(3, 1, 'Page jaunes', 'radio', 2, 3, ''),
(4, 2, 'Appel sur ?', 'libelle', 0, 0, ''),
(5, 2, 'Réparateur qualifié', 'radio', 5, 2, ''),
...
(71, 17, 'SAV - Volet marque Bubendorff vendu par le point conseil', 'radio', 18, 2, ''),
...
--
ALTER TABLE `script_data`
  MODIFY `script_data_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `script_data_child`
--
ALTER TABLE `script_data_child`
  MODIFY `script_data_child_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
