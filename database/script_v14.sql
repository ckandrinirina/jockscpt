...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2020 at 03:21 PM
...
--
ALTER TABLE `script_data`
  MODIFY `script_data_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `script_data_child`
--
ALTER TABLE `script_data_child`
  MODIFY `script_data_child_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=193;
